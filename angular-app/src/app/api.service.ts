...
export class ApiService {
  private expressApiUrl = 'http://48.211.129.65:3000/api/grades'; // Adjust the URL as necessary
  private flaskApiUrl = 'http://48.211.128.16:5000/api/generate'; // Adjust the URL as necessary
